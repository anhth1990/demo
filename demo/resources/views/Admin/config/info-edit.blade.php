...
<h3 class="page-title">
{{trans('config.config')}} <small>{{trans('config.config_info')}}</small>
</h3>
<!--====================================================================================================================================-->
<div class="row">
    <div class="col-md-12">
        <div class="tabbable-line boxless tabbable-reversed">
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <?php echo Form::model($config, ['class'=>'form-horizontal','method'=>'post','id'=>'form_validate','role'=>'form','enctype'=>'multipart/form-data'  ]);?>
                        ...
                        <div class="form-body">
							...
							<div class="form-group">                   											
								...
								<label class="control-label col-md-2">{{trans('config.demo_image')}}</label>
                                <div class="col-md-4">
                                    <img src="{{Asset($config->image)}}" style="width:200px">
                                </div>	
                            </div>	
							<div class="form-group">                   											
