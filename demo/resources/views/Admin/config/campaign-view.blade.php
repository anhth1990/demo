...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="">{{trans('config.campaign_view')}}</a>
        </li>
    </ul>
</div>
<h3 class="page-title">
    {{trans('config.campaign_view')}}
</h3>  
<!--====================================================================================================================================-->
<div class="row">
    <div class="col-md-12">
        <div class="tabbable-line boxless tabbable-reversed">
            <div class="portlet box blue ">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-plus-square"></i>{{trans('config.campaign_view')}}
                    </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    ...
                    @endif
                    <!-- BEGIN FORM-->
                    <?php echo Form::model($campaign, ['class'=>'form-horizontal','method'=>'post','id'=>'form_validate','role'=>'form','enctype'=>'multipart/form-data'  ]);?>
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <?php echo Form::text('campaign',null, ["class" => "form-control","id"=>"campaign","value"=>"{!! old('campaign') !!}"]);?>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="input-group input-large date-picker input-daterange" data-date="10/11/2012" data-date-format="mm/dd/yyyy">
                                        <?php echo Form::text('start_date',null, ["class" => "form-control","id"=>"start_date","value"=>"{!! old('start_date') !!}"]);?>
                                        <span class="input-group-addon">
                                            to </span>
                                        <?php echo Form::text('finish_date',null, ["class" => "form-control","id"=>"finish_date","value"=>"{!! old('finish_date') !!}"]);?>
                                    </div>
                                </div>	
                            </div>	
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <?php echo Form::text('block',null, ["class" => "form-control","id"=>"block","value"=>"{!! old('block') !!}"]);?>
                                </div>	
                            </div>	
                            <div class="form-group">
                                <label class="control-label col-md-2">{{trans('config.exchange')}}<span class="required" aria-required="true"> * </span></label>
                                <div class="col-md-4">
                                    <?php echo Form::text('exchange',null, ["class" => "form-control","id"=>"exchange","value"=>"{!! old('exchange') !!}"]);?>
                                </div>
                        ...
                        <div class="form-actions">
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <a href="{{Asset('/'.$admin_local.'/campaign')}}" class="btn default">{{trans('layout.back')}}</a>
                                </div>
                            </div>
                        </div>
                    </form>
