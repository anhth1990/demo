...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="">{{trans('user.changepass')}}</a>
		</li>
	</ul>
</div>
...
<div class="portlet box blue-madison ">
	...
	<div class="portlet-body form">
		<?php echo Form::model($account, ['url' => ['/edit-account'],'class'=>'form-horizontal','method'=>'post','id'=>'form_validate','role'=>'form'  ]);?>
			<input type="hidden" name="_token" value="<?php echo csrf_token();?>">
			<div class="form-body">
				<div class="form-group" id="form_username">
					<label class="col-md-3 control-label">{{trans('user.acc_user')}}</label>
					<div class="col-md-9">
						<?php echo Form::text('username',null, ['class' => 'form-control','id'=>'username','onblur'=>'checkUser()','disabled'=>'disabled']);?>
						<?php echo Form::hidden('id',null, ['class' => 'form-control','id'=>'id']);?>
				...
				<div class="form-group" id="form_fullname">
					...
					<div class="col-md-9">
						<?php echo Form::text('fullname',null, ['class' => 'form-control','id'=>'fullname','disabled'=>'disabled']);?>
				...
				<div class="form-group" id="form_email">
					...
					<div class="col-md-9">
						<?php echo Form::text('email',null, ['class' => 'form-control','id'=>'email','onblur'=>'checkEmail()','disabled'=>'disabled']);?>
			...
			<div class="form-actions">
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<a onclick="submitForm()" class="btn blue-madison">{{trans('user.update_submit')}}</a>
						<a href="{{url('/user')}}" class="btn default">{{trans('user.cancel')}}</a>
					</div>
				</div>
			</div>
		</form>
...
<script>
        function checkUser(){
            ...
            var link = "{{Asset('/report/account/checkUser')}}";
                jQuery.ajax({
                    url : link,
        ...
        function checkEmail(){
            var email = $('#email').val();
            var link = "{{Asset('/report/account/checkEmail')}}";
                jQuery.ajax({
                    url : link,
                    data : "email="+email,
                    type : "get",
