...
class Contact extends Model {
	...
	public function getContactByUserShopId($id_user,$id_shop){
		try {
            $data = Contact::select('*')->where('id_user', $id_user)->where('id_shop', $id_shop)->get();
            return $data;
        } catch (Exception $e) {
            return $e;
        }
	...
	public function UpdateDataByShopUserId($id_user, $id_shop, $data) {
        try {
            Contact::where("id_user", "=", $id_user)->where("id_shop", "=", $id_shop)->update($data);
            return true;
        } catch (Exception $e) {
            return $e;
        }
